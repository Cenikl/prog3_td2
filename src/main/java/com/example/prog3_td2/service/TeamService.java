...
public class TeamService {
    ...
    public List<TeamEntity> getAuthors() {
        return repository.findAll();
    }

    public List<TeamEntity> createAuthors(List<TeamEntity> toCreate) {
        return repository.saveAll(toCreate);
    }

    public List<TeamEntity> updateAuthors(List<TeamEntity> toUpdate) {
